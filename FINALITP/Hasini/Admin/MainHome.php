...
<!--<button class="button8" name="updateprofile" style ="float:center"><a href="StaffRegB.php"><font size="5em",font color="black">StaffRegistration</font></a></button><br>-->
 <button class="button1" style ="float:center"><a href="userLogin.php"><font size="5em",font color="black">Login</font></a></button>
...
<button class="button7" style ="float:center"><a href="StaffRegSelect.php"><font size="5em",font color="black">All Staff Details</font></a></button>
