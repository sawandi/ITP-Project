...
<head>
	...
	<style>
		body
		{
			background:url(images/images11.jpg);
...
<button class="button" style ="float:center"><a href="ProductStock.php"><font size="5em",font color="black">Add New Product</font></a></button>
<button class="button" style ="float:center"><a href="GetPDF.php"><font size="5em",font color="black">GetPDF</font></a></button>
<button class="button" style ="float:center"><a href="FilterProductStock1.php"><font size="5em",font color="black">Search Product</font></a></button>
