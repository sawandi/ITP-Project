...
<link rel = "stylesheet" type="text/css" href = "styles/table2XYZ.css">
...
<button class="button" style ="float:center"><a href="FilterStaffReg.php"><font size="5em",font color="black">Search Staff Details</font></a></button>
