...
<?php
	...
	if(isset($_POST['login']))
	{
		...
		$query = "SELECT p.Status from petowners p,userlogindetails u where p.UserID = u.UserID and u.Username='$username'";
				...
				if($userType == "Pet Owner")
				{
						...
						//{
							...
							if($db_pw == $hashed && $db_uname == $username)
							{
								...
								<script type = "text/javascript">
									...
									window.location = "../Home/MainHomePetOwner.php";
								</script>
					...
					else
					{
						?>
							...
							<div id = "alert" class="alert alert-warning" role="alert">
								<strong>Warning!</strong> Sorry, You are not a active user now??
							</div>
				...
				else if($userType == "Receptionist")//check user type
				{
					...
					if($db_pw == $hashed && $db_uname == $username)
					{
						...
						?>
							...
							<script type = "text/javascript">
								alert("Successfully login!!!");
								window.location = "../Home/MainHomeReceptionist.php";
							</script>
				...
				else if($userType == "Admin")
				{
					...
					if($db_pw == $hashed && $db_uname == $username)
					{
						...
						?>
							...
							<script type = "text/javascript">
								alert("Successfully login!!!");
								window.location = "../Home/MainHomeAdmin.php";
							</script>
