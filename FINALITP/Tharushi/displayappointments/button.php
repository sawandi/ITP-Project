    ...
    <div class="modal fade" id="edit<?php echo $row['AppointmentId']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				?>
				<div class="container-fluid">
				<form method="POST" action="edit.php?id=<?php echo $erow['AppointmentId']; ?>">
					...
					<!--div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="UserId" class="form-control" value="<?php echo $erow['UserId']; ?>">
						</div>
					</div>-->
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="service" class="form-control" value="<?php echo $erow['service']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="petage" class="form-control" value="<?php echo $erow['petage']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="petgender" class="form-control" value="<?php echo $erow['petgender']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="date" name="adate" class="form-control" value="<?php echo $erow['adate']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="time" name="atime" class="form-control" value="<?php echo $erow['atime']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
